...
class QuestionController extends GetxController
  ...
  List<ScienceQues> _questions = sample_data
      .map(
        (question) => ScienceQues(
            id: question['id'],
      ...
      .toList();
  List<ScienceQues> get questions => this._questions;
  ...
  void checkAns(ScienceQues question, int selectedIndex) {
